    ...
    <div class="max-w-7xl mx-auto px-(--spacing-margin-mobile) md:px-(--spacing-margin-desktop)">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-on-primary">
        ...
        <div class="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4">
          <div
            class="w-14 h-14 md:w-16 md:h-16 rounded-full bg-on-primary/15 flex items-center justify-center shrink-0"
          >
            <!-- ICON -->

            <svg fill="#FFED94" width="30" height="30" viewBox="0 0 220 260">
              <path
                d="M123,43V28h16V2H81v26h16v15C43.696,49.44,2,95.241,2,150.253C2,209.665,50.335,258,109.747,258s107.747-48.335,107.747-107.747C217.494,95.241,176.304,49.44,123,43z"
              />
            </svg>
          </div>

          <div>
            <h3 class="font-bold text-lg">Menos de 30 minutos</h3>

            <p class="opacity-80 text-sm md:text-base">Livraison rapide et fraîche.</p>
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4">
          ...
          >
            <svg
              ...
              width="44px"
              height="44px"
              viewBox="0 -18.83 122.88 122.88"
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              style="enable-background: new 0 0 122.88 85.22"
              xml:space="preserve"
          ...
          <div>
            ...
            <p class="opacity-80 text-sm md:text-base">Commandez et récupérez rapidement.</p>
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4">
          ...
          >
            ...
            >
              <path
                d="M72,21.9 C69.3,19 66.3,17 62.7,17 L37.3,17 C33.7,17 30.7,19 28,21.9 C24.5,25.6 22,31.7 22,38.9 L22,72 C22,78.1 26.9,83 33,83 L67,83 C73.1,83 78,78.1 78,72 L78,38.9 C78,31.7 75.5,25.6 72,21.9 Z M67,77.4 L33,77.4 C30,77.4 27.6,75 27.6,72 L27.6,38.9 C27.6,33.5 29.3,29.1 32,26.2 C33.8,24.3 35.8,22.6 37.3,22.6 L62.7,22.6 C64.2,22.6 66.2,24.3 68,26.2 C70.7,29.1 72.4,33.5 72.4,38.9 L72.4,72 C72.4,75 70,77.4 67,77.4 Z M42.7,35 C42.7,33.1 44.3,31.5 46.2,31.5 L53.8,31.5 C55.7,31.5 57.3,33.1 57.3,35 C57.3,36.9 55.7,38.5 53.8,38.5 L46.2,38.5 C44.3,38.5 42.7,36.9 42.7,35 Z M50,49.8 C56.6,49.8 61.9,55.1 61.9,61.7 C61.9,68.3 56.6,73.6 50,73.6 C43.4,73.6 38.1,68.3 38.1,61.7 C38.1,55.1 43.4,49.8 50,49.8 Z M50,68 C53.5,68 56.3,65.2 56.3,61.7 C56.3,58.2 53.5,55.4 50,55.4 C46.5,55.4 43.7,58.2 43.7,61.7 C43.7,65.2 46.5,68 50,68 Z"
                fill="#FFED94"
              />
            </svg>
          </div>
          ...
          <div>
            <h3 class="font-bold text-lg">À domicile</h3>

            <p class="opacity-80 text-sm md:text-base">Livraison directement chez vous.</p>
          </div>
        </div>
      </div>
    </div>
